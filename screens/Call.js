        ...
        {isBusy === false && typeof listFriends === 'undefined' ? (<>
          ...
          {listFriends.find(element => element === item.uid) ? (<>
            <View style={{
              ...
              <TouchableOpacity style={{marginLeft: 10, marginRight: 10}} onPress={ () => { navigation.navigate('voicecall', {user:item}) }}>
                <FontAwesome name="phone" size={26} color="#42C2FF" />
              </TouchableOpacity >
                <TouchableOpacity style={{marginLeft: 10, marginRight: 10}} onPress={ () => { navigation.navigate('videochat', {user:item}) }}>
