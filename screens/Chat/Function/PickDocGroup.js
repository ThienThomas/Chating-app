...
export default function PickDocGroup({route}){
    ...
    async function UploadDocs(){
        const {url, fileName} = await uploadDocuments(document.uri,  `chatgroups/${docid}/documents/`, ext)
        const message = {
          _id : fileName,
          text: "",
            ...
            <View
                ...
                >
                    ...
                    >   
                        ...
                        <Text style={{color: 'black', fontSize: 18, opacity: 1, fontWeight: 'bold'}}>Nhóm</Text>
                    </View>
                    <TouchableOpacity
                   onPress={() => {UploadDocs()}}
                    style={{
